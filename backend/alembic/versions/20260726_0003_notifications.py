...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("include_subtree", sa.Boolean(), nullable=False, server_default=sa.true()),
        ...
        sa.Column("critical_ignores_quiet_hours", sa.Boolean(), nullable=False, server_default=sa.true()),
